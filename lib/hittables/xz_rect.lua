...
---@overload fun(x0: number, x1: number, z0: number, z1: number, k: number, mat: material)
---@field x0 number
---@field x1 number
---@field z0 number
---@field z1 number
...
function xz_rect:bounding_box(time0, time1, output_box)
	...
	output_box:replace_with(aabb(point3(self.x0, self.k - 0.0001, self.z0), point3(self.x1, self.k + 0.0001, self.z1)))
	return true
end
